...
abstract class TestCase {
	...
	protected function assertGreaterThan(mixed $bound, mixed $actual, string $message = ''): void {
		$this->assertionCount++;
		if (!($actual > $bound)) {
	...
	protected function assertLessThan(mixed $bound, mixed $actual, string $message = ''): void {
		$this->assertionCount++;
		if (!($actual < $bound)) {
