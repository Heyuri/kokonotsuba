<form id="boardConfigForm" action="{$LIVE_INDEX_FILE}?mode=globalConfig" method="POST" data-msg-no-changes="{$MSG_NO_CHANGES}" data-msg-failed="{$MSG_SAVE_FAILED}" data-msg-confirm="{$MSG_CONFIRM_SAVE}" data-msg-more="{$MSG_CONFIRM_MORE}">
