...
$language['search_notice']				= '<li>Please enter a keyword and set the search target, then press the <q>Search</q> button.</li><li>Searching multiple keywords can be done by seperating keywords with space.</li><li>You can set the search method (<q>AND</q>, <q>OR</q>) when searching multiple keywords.</li>';
...
$language['search_target_topic']		= 'Subject';
