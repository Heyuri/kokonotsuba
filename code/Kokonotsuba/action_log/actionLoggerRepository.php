...
class actionLoggerRepository {
	...
	public function getFullActionLog(): array {
		...
		$logs = $this->databaseConnection->fetchAllAsClass($query, [], '\Kokonotsuba\action_log\loggedActionEntry');
	...
	public function fetchLogEntries(int $amount, int $offset, array $filters, string $order): array {
		...
		return $this->databaseConnection->fetchAllAsClass($query, $params, '\Kokonotsuba\action_log\loggedActionEntry') ?? [];
	}
