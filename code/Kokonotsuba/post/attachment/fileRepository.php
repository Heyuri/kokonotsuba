...
class fileRepository {
	...
	public function getFileById(int $fileId): false|fileEntry {
		...
		$fileEntry = $this->databaseConnection->fetchAsClass($query, $params, '\Kokonotsuba\post\attachment\fileEntry');
	...
	public function getFilesForPost(int $postUid): false|array {
		...
		$fileEntries = $this->databaseConnection->fetchAllAsClass($query, $params, '\Kokonotsuba\post\attachment\fileEntry');
	...
	public function getAttachmentsFromPostUids(array $postUids): false|array {
		...
		$attachments = $this->databaseConnection->fetchAllAsClass($query, $params, '\Kokonotsuba\post\attachment\fileEntry');
