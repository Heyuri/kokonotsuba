...
$language['regist_upload_notsupport']	= 'アップロードに失敗しました<br>GIF,JPG,PNG以外の画像ファイルは受け付けません (%1$s - %2$s)';
...
$language['regist_withouttag']			= 'スレッドのタグを選んでください。';
...
$language['admin_list_header']			= '<th>機能</th><th>ストップ</th><th>削除</th><th>投稿日</th><th>題名</th><th>投稿者</th><th>コメント</th><th>ホスト名</th><th>ブラウザ</th><th>添付(Bytes)<br>MD5</th>';
...
$language['search_notice']				= '<li>お探しの記事に関連する言葉をキーワード入力欄に入力して検索ボタンを押してください。</li><li>複数のキーワードの間にスペースを入れて入力します。</li><li>複数キーワード間の検索条件を細かく指定する場合に利用します。</li><li>キーワードの前に <q>-</q> を付けると、その語を含む投稿を除外できます（例：<q>猫 -犬</q>）。</li><li>注意：3文字未満の単語やごく一般的な単語は無視されることがあり、検索されるのは文字と数字のみで、記号などは対象外です。</li>';
$language['search_keyword']				= 'キーワード';
