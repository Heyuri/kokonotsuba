...
$language['regist_upload_notsupport']	= 'Desteklenmeyen resim. (%1$s - %2$s)';
...
$language['regist_thread_too_old']		= 'Bu thread yeni yanıtlar alamayacak kadar eski!';
...
$language['search_notice']				= '<li>Lütfen anahtar kelimeleri girip aramanın hedefini seçin, ve <q>Ara</q> butonuna basın.</li><li>Aralarında boşluk bırakarak birden fazla anahtar kelimeyi arayabilirsiniz.</li><li>Arama metodunu (<q>VE araması</q> ve <q>YA DA araması</q>) yaparak farklı şekillerde birden fazla anahtar kelime arayabilirsiniz.</li><li>Bir anahtar kelimenin önüne <q>-</q> ekleyerek onu içeren gönderileri hariç tutabilirsiniz (ör. <q>kedi -köpek</q>).</li><li>Not: 3 harften kısa kelimeler ve çok yaygın kelimeler göz ardı edilebilir; yalnızca harfler ve rakamlar aranır — noktalama ve diğer simgeler dikkate alınmaz.</li>';
...
$language['search_target_tag']			= 'Etiket';
$language['search_tag_all']				= 'Bütün etiketler';
...
$language['form_contpost']				= 'Üst üste';
...
$language['pm_delete_btn'] = 'Seçilenleri sil';
...
$language['anon_ip_now']              = 'Tüm postlar (şimdi)';
$language['anon_ip_submit']           = 'Anonimleştir';
$language['anon_ip_success']          = '%d IP adresi anonimleştirildi.';
$language['anon_ip_dispatched']       = 'Anonimleştirme görevi sıraya alındı. Tamamlandığında bilgilendirileceksiniz.';
$language['anon_ip_completed']        = 'IP anonimleştirme işlemi başarıyla tamamlandı.';
$language['anon_ip_dispatch_failed']  = 'Anonimleştirme görevi başlatılamadı. Lütfen tekrar deneyin.';
$language['anon_ip_invalid_request']  = 'Geçersiz anonimleştirme isteği.';
