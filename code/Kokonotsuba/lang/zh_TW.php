...
$language['regist_upload_notsupport']	= '附加圖檔為系統不支援的格式 (%1$s - %2$s)';
...
$language['del_restored_locked']		= '此文章無法再被刪除。';
...
$language['admin_list_header']			= '<th>功能</th><th>停止</th><th>刪除</th><th>投稿日</th><th>標題</th><th>名稱</th><th>內文</th><th>主機位置名稱</th><th>瀏覽器</th><th>附加圖檔 (Bytes)<br>MD5 檢查碼</th>';
...
$language['search_notice']				= '<li>請輸入要搜尋的關鍵字，設定好搜尋目標之後，按下「搜尋」按鈕。</li><li>關鍵字使用半形空白可以區隔多個搜尋關鍵字作搜尋。</li><li>如果有多個關鍵字，可以選擇搜尋方法，系統提供 AND(交集) 和 OR(聯集) 方式搜尋。</li><li>在關鍵字前加上 <q>-</q> 可以排除包含該詞的貼文（例如 <q>貓 -狗</q>）。</li><li>注意：少於 3 個字母的詞和過於常見的詞可能會被忽略，且只搜尋字母和數字，標點及其他符號不會被檢索。</li>';
$language['search_keyword']				= '關鍵字';
