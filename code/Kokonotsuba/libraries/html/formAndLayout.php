...
function preparePostFormTemplateValues(int $resno, ?string $liveIndexFile, ?string $name, ?string $email, ?string $subject, ?string $comment, array $config, bool $isThread, ?string $moduleInfoHook, bool $isStaff = false) {
	...
	return array(
		...
		'{$FORM_SUBMIT}' => '<button id="buttonPostFormSubmit" type="submit" name="mode" value="regist">' . ($resno ? _T('form_submit_reply') : _T('form_submit_new_thread')) . '</button>',
		...
		'{$FORM_TAG_FIELD}' => '',
		'{$FORM_NAME_LABEL}' => _T('form_name'),
		'{$FORM_EMAIL_LABEL}' => _T('form_email'),
		'{$FORM_TOPIC_LABEL}' => _T('form_topic'),
		'{$FORM_COMMENT_LABEL}' => _T('form_comment'),
		'{$FORM_FILE_LABEL}' => _T('form_attechment'),
		'{$FORM_NOFILE_LABEL}' => _T('form_noattechment'),
		'{$FORM_CONTPOST_LABEL}' => _T('form_contpost'),
		'{$FORM_PASSWORD_LABEL}' => _T('form_delete_password'),
		'{$FORM_PASSWORD_NOTICE}' => _T('form_delete_password_notice'),
		'{$FORM_CATEGORY_LABEL}' => _T('form_category'),
		'{$FORM_CATEGORY_NOTICE}' => _T('form_category_notice'),
		'{$FORM_TAG_LABEL}' => _T('form_tag'),
		'{$POST_FORM}' => '');
}
