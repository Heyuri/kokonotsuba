...
class accountRepository {
	...
	public function getAllAccounts() {
		...
		return $this->databaseConnection->fetchAllAsClass($query, [], '\Kokonotsuba\account\staffAccount');
	}

	public function getAccountByID($id) {
		$query = "SELECT * FROM {$this->accountTable} WHERE id = :id";
		$params = [':id' => $id];
		return $this->databaseConnection->fetchAsClass($query, $params, '\Kokonotsuba\account\staffAccount');
	}
