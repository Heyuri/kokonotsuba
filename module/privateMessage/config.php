...
return [
	...
	'APPEND_TRIP_PM_BUTTON_TO_POST' => boolField('config_label_modules.privateMessage.APPEND_TRIP_PM_BUTTON_TO_POST', true, 'config_desc_modules.privateMessage.APPEND_TRIP_PM_BUTTON_TO_POST'),
];
