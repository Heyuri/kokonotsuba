...
';
	...
	public function handleBoardRequests() {
		...
		if(!empty($_POST['new-board'])) {
			...
			$boardSubTitle = $_POST['new-board-sub-title'] ?? $_POST['new-board-sub-title'];
			...
			try {
				...
				//create cdn dirs
				$boardUploadedFilesImgDir = $this->config['USE_CDN'] ? $cdnDir.$mockConfig['IMG_DIR'] : $fullBoardPath.$mockConfig['IMG_DIR'];
				$boardUploadedFilesThumbDir = $this->config['USE_CDN'] ? $cdnDir.$mockConfig['THUMB_DIR'] : $fullBoardPath.$mockConfig['THUMB_DIR'];
				createDirectoryWithErrorHandle($boardUploadedFilesImgDir, $globalHTML);
				createDirectoryWithErrorHandle($boardUploadedFilesThumbDir, $globalHTML);
				$createdPaths[] = $boardUploadedFilesImgDir;
				$createdPaths[] = $boardUploadedFilesThumbDir;
				...
				//create board storage dir
				$dataDir = getBoardStoragesDir().$mockConfig['STORAGE_DIR_PREFIX'].'-'.$newBoardUID;
