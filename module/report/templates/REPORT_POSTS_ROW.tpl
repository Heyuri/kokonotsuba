	<tr class="reportedPostRow">
		...
		<td class="colApprovedCount">{$APPROVED_COUNT}</td>
		<td class="colDismissedCount">{$DISMISSED_COUNT}</td>
		<td class="colDate">{$LAST_REPORTED}</td>
		<td class="colActions">[<a href="{$POST_REPORTS_URL}">{$VIEW_TEXT}</a>]</td>
	</tr>
