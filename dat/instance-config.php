<?php
/*
* Treat this file as a instance-wide config. Overwrite values in here in the root-config if you want board specific settings. Although some settings are exclusive to root-config
*/
