...
$language['admin_list_header']			= '<th>Func</th><th>Del</th><th>Date</th><th>Subject</th><th>Name</th><th>Comment</th><th>Host</th><th>Image (Bytes)<br />MD5 checksum</th>';
...
$language['search_notice']				= '<li>Please enter keyword and set search target, then press <q>Search</q> button.</li><li>Searching with multiple keywords can be done by seperating keywords with space.</li><li>You can set Search method(<q>and searching</q> and <q>or searching</q>) for multiple keywords searching.<p />Keyword:';
